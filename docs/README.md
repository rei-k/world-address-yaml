...
| [ai/](./ai/) | **NEW!** AI機能 - AI機能強化戦略・送り状AIなど、システムのAI機能に関するドキュメント |
| [ai/ai-capabilities.md](./ai/ai-capabilities.md) | **NEW!** AI機能強化戦略 - 検索精度・安全性・相互運用性を向上させる5つのAI機能 |
| [ai/waybill-ai-capabilities.md](./ai/waybill-ai-capabilities.md) | **NEW!** 送り状AI・アルゴリズム - 送り状の生成・検索・管理における10のAI機能 |
...
3. **[AI機能強化戦略](./ai/ai-capabilities.md)** 🆕
...
4. **[送り状AI・アルゴリズム](./ai/waybill-ai-capabilities.md)** 🆕
   - Waybill Parse AI（送り状構造解析）
   - Carrier Adapt AI（配送業者適合）
   - PID Embed AI（PID埋め込み・検索）
   - Field Align AI（フィールド整合）
   - Error Prevent AI（エラー防止）
   - FedEx-like Ranking Search（ランク検索）
   - Fraud Block LSH（不正ブロック）
...
6. **[システムアーキテクチャ](./cloud-address-book-architecture.md)**
   - システム全体構成
   - データフロー詳細
   - コンポーネント設計
   - セキュリティアーキテクチャ
...
7. **[実装ガイド](./cloud-address-book-implementation.md)**
   - 開発環境セットアップ
   - 基本的な使用例
   - 住所登録の実装
   - 友達管理の実装
